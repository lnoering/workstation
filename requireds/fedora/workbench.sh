...
sudo wget http://dev.mysql.com/get/Downloads/MySQLGUITools/mysql-workbench-community-6.3.10-1.fc27.x86_64.rpm

sudo dnf -y install ./mysql-workbench-community-6.3.10-1.fc27.x86_64.rpm

sudo rm ./mysql-workbench-community-6.3.10-1.fc27.x86_64.rpm
